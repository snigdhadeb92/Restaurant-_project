        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="{{route('addResturant')}}">Add Resturent</a>
                </li>
                <li class="nav-item">
                ...
                @else
                  ...
                  <li class="nav-item">
                      <a class="nav-link" href="{{route('registration')}}" tabindex="-1" aria-disabled="true">Register</a>
                  </li>
                @endif
